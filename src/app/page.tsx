...
export default function Home() {
  ...
  return (
    <main className='max-h-[-webkit-fill-available]'>
      {/* hero img */}
      <Navbar />
      <div className='bg-hero-img relative h-[463px] '>
        <div className='relative top-[106px] w-full '>
          <div className='flex justify-center'>
            <div className=' md:w-[unset] lg:w-[865px] xl:w-[1200px]'>
              <div className='flex flex-col '>
                <span className='bolt text-[46px] font-black uppercase tracking-normal text-[#FFFFFF] md:text-[64px]/[64px] '>
                  beter laswerk
                </span>
      ...
      <div className=' w-full bg-white mb-[110px]'>
        <div className='  flex justify-center '>
          <div className=' flex flex-col items-center justify-between gap-[30px] px-[35px] pt-[30px] sm:gap-[35px] sm:pt-[46px] md:w-[1200px] xl:flex-row xl:items-start'>
            ...
            <div className='bg-hek hovered flex h-[160px] w-full flex-col rounded-[5px] bg-[#E9EDF3] pb-[35px] sm:h-[250px] sm:w-[575px]'>
              <div className='px-[35px]  sm:top-[50px] md:pt-[35px]'>
            ...
            {/* grijz blok met trap */}
            <div className='bg-trap hovered flex h-[160px] w-full flex-col rounded-[5px] bg-[#E9EDF3] sm:h-[250px] sm:w-[575px]'>
              <div className='px-[35px] sm:top-[50px] md:pt-[35px]'>
                <span className='text-[40px]/[104px] font-black uppercase tracking-normal text-[#1C355D] text-opacity-[0.03] sm:text-[69px]/[179px]'>
                  constructies
                </span>
...
-235 -20z'
          ...
          <div className='flex w-full max-w-[unset] justify-center px-[35px] py-[27px] text-center md:px-0 lg:max-w-[720px] xl:text-left '>
            <p>
      ...
      <div className='absolute left-0  right-0 top-[3498px] flex justify-center sm:top-[3989px] md:justify-start md:pl-[35px] lg:top-[3691px] lg:justify-center lg:pl-[unset] xl:top-[3521px]'>
        <Nieuws />
      </div>

      <div className='absolute left-0  right-0 top-[4092px] flex justify-center sm:top-[4634px] sm:max-w-[750px] md:top-[4803px] md:max-w-[unset] lg:top-[4339px]'>
        <Reviews />
      </div>

      <BelOns />

      <div className='absolute left-0 right-0 top-[4786px] h-[91%] sm:top-[5377px]  md:top-[5562px] lg:top-[5099px]'>
        <BlauweBalk />
        <FooterDesktop />
        <FooterMobile />
      </div>
