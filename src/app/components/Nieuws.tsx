...
const Nieuws = () => {
  return (
    <div className='w-[1200px] sm:px-[35px] xl:pl-[unset]'>
      <div className='flex flex-row items-center justify-center lg:justify-between lg:items-start '>
...
-235 -20z'
      ...
      <div className='mb-[40px] px-[35px] lg:max-w-[360px] lg:px-0'>
        <p className='flex justify-center lg:justify-start text-center text-[15px] text-[#1C355D] lg:text-left'>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
          nonumy eirmod tempor invidunt ut
        </p>
      </div>

      <div className='mb-[80px] flex justify-center lg:justify-start'>
        <CarouselNieuws />
      </div>
    </div>
  );
