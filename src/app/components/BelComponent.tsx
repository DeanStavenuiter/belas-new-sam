...
const BelOns = () => {
  ...
  return (
    <>
      <div className='fixed bottom-[67px] z-10 right-0 max-w-[200px] md:right-[180px] lg:right-[330px]'>
      ...
      {/* blauwe balk */}
      <div className='flex h-[67px] w-full gap-[10px] fixed bottom-0 bg-[#1A3055] px-[35px] py-[11px] sm:hidden'>
