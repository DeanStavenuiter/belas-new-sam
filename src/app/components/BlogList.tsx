...
const BlogList = () => {
  return (
    <div className=' z-[7] fixed right-[330px] top-[373px] h-[281px] w-[327px] rounded-[10px] border bg-white pb-[30px] pl-[30px] pr-[52px] pt-[36px] shadow-[0px_3px_15px_#34343419]'>
      <div className='mb-[13px] flex flex-row items-center gap-[31px] text-[16px]/[19px] font-semibold tracking-normal text-[#1C355C]'>
      ...
      <ul className='flex flex-col gap-[13px] pl-[2px] text-[15px]/[20px] tracking-normal text-[#1C355C]'>
