    ...
    <>
      <div className='relative z-0 flex bg-[#182228] md:hidden md:px-[180px] xl:px-[360px]'>
        <div className='flex flex-col justify-center px-[35px] md:px-0 '>
          <span className='mt-[29px] text-[73px] font-black uppercase tracking-normal text-[#FFFFFF] opacity-[0.03] md:mt-[97px]'>
            Belas VOF
          </span>
          <div className='relative bottom-[50px] flex justify-start text-[31px] font-semibold tracking-normal text-white'>
            <h2>Belas VOF</h2>
          </div>
          ...
          <div className='mb-[45px] mt-[80px] flex justify-start text-[31px] font-semibold tracking-normal text-white'>
            <h4>Service</h4>
          </div>
          ...
          <div className='flex flex-row gap-[80px] border-b-[1px] border-white border-opacity-20 pb-[80px] text-[15px]/[25px] font-normal tracking-normal text-white '>
            <div className=''>
              <ul>
                <li>
          ...
          <div className='flex flex-col py-[35px] text-[15px]/[25px] font-normal tracking-normal text-white'>
